...
public class BinaryExpressionNode extends Node
{
	...
	{
		return op == NOTEQUALS_TOKEN || op == STRICTNOTEQUALS_TOKEN || op == LOGICALAND_TOKEN || op == LOGICALXOR_TOKEN || op == LOGICALXORASSIGN_TOKEN || op == LOGICALOR_TOKEN || op == LESSTHAN_TOKEN || op == LESSTHANOREQUALS_TOKEN || op == EQUALS_TOKEN || op == STRICTEQUALS_TOKEN || op == GREATERTHAN_TOKEN || op == GREATERTHANOREQUALS_TOKEN;
	}
