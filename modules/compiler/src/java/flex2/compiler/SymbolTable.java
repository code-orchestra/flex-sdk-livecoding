...
public final class SymbolTable {
    ...
    // codeorochestra - moved from TypeAnalizer
    public Map<String, ClassInfo> classInfoMap = new HashMap<String, ClassInfo>();
    public Map<String, InterfaceInfo> interfaceInfoMap = new HashMap<String, InterfaceInfo>();

    public synchronized InterfaceInfo addInterfaceInfo(String s, InterfaceInfo interfaceInfo) {
        return interfaceInfoMap.put(s, interfaceInfo);
    }

    public synchronized InterfaceInfo getInterfaceInfo(String fqn) {
        return interfaceInfoMap.get(fqn);
    }

    public synchronized ClassInfo getClassInfo(String fqn) {
        return classInfoMap.get(fqn);
    }

    public synchronized ClassInfo addClassInfo(String fqn, ClassInfo classInfo) {
        return classInfoMap.put(fqn, classInfo);
    }
     ...
     */
    synchronized void registerQNames(QNameList qNames, Source source) {
     ...
     */
    synchronized void registerMultiName(MultiName multiName, QName qName) {
        multiNames.put(multiName, qName);
    }

    synchronized void registerResourceBundleName(String rbName, QName[] qNames) {
