...
public class CSSChildSelector extends AbstractDescendantSelector {
    ...
    public boolean match(Element e, String pseudoE) {
        ...
        return n != null && n.getNodeType() == Node.ELEMENT_NODE && ((ExtendedSelector) getAncestorSelector()).match((Element) n, null) && ((ExtendedSelector) getSimpleSelector()).match(e, pseudoE);
    }
