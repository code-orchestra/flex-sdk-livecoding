...
public class PreLink implements flex2.compiler.PreLink
{
                        ...
                        Configuration configuration)
    {
        ...
        sources.addAll(extraSources.stream().map(resources::addResource).collect(Collectors.toList()));
            ...
            if (u.isRoot())
            {
                ...
                if (qName != null)
                {
                    ...
                    if (u.loaderClass != null || u.loaderClassBase != null)
                    {
                        ...
                        Set<String> cssFilesSet = cssFiles.stream().map(VirtualFile::getName).collect(Collectors.toSet());
                        ...
                        {
                            Set<String> secondCssFilesSet = cssFiles.stream().map(VirtualFile::getName).collect(Collectors.toSet());
